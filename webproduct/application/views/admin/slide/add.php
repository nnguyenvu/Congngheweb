...
<div class="wrapper">
	   	...
	   	<!-- Form -->
		<form class="form" id="form" action="<?php echo base_url('admin/slide/add')?>" method="post" enctype="multipart/form-data">
			<fieldset>
				<div class="widget">
				    <div class="title">
					...
					<div class="tab_container">
					     <div id="tab1" class="tab_content pd0">
					         <div class="formRow">
										<label class="formLeft" for="param_name">Teen slide:<span class="req">*</span></label>
										<div class="formRight">
