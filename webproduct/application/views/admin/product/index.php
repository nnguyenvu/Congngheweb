	...
	<div class="widget">
		...
		<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable" id="checkAll">
			...
			<thead class="filter"><tr><td colspan="6">
				<form class="list_filter form" action="<?php echo base_url('admin/product')?>" method="get">
					<table cellpadding="0" cellspacing="0" width="80%"><tbody>
						...
						<tr>
							...
							<input type="reset" class="basic" value="Reset" onclick="window.location.href = '<?php echo base_url('admin/product/')?>'; ">
							</td>
				...
				<tr>
					<td colspan="6">
						<div class="list_action itemActions">
								<a url="<?php echo base_url('admin/product/delete_all')?>" class="button blueB" id="submit" href="#submit">
			...
			<?php foreach ($list as $row):?>
			      <tr class="row_<?php echo $row->id?>">
					...
					<td class="option textC">
						 ...
						 <a href="<?php echo base_url('admin/product/edit/'.$row->id)?>" title="Chỉnh sửa" class="tipS">
							<img src="<?php echo public_url('/admin/images/') ?>icons/color/edit.png">
						</a>
						
						<a href="<?php echo base_url('admin/product/del/'.$row->id)?>" title="Xóa" class="tipS verify_action">
