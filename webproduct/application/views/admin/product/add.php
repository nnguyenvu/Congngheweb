...
<div class="wrapper">
	   	...
	   	<!-- Form -->
		<form class="form" id="form" action="<?php echo base_url('admin/product/add')?>" method="post" enctype="multipart/form-data">
			<fieldset>
				<div class="widget">
				    <div class="title">
...
<div class="formRow">
	...
	<div class="formRight">
		<span>
			...
			<img class="tipS" original-title="Số tiền giảm giá" style="margin-bottom:-8px" src="<?php echo public_url('/admin')?>/crown/images/icons/notifications/information.png">
		</span>
