				...
				<tr>
					<td colspan="7">
					     <div class="list_action itemActions">
								<a href="#submit" id="submit" class="button blueB" url="<?php echo base_url('admin/catalog/delete_all')?>">
			...
			<tbody>
				...
				<tr class="row_<?php echo $row->id ?>">
						...
						<td class="option">
							 ...
							 <a href="<?php echo base_url('admin/catalog/edit/'.$row->id)?>" title="Chỉnh sửa" class="tipS ">
							<img src="<?php echo public_url('/admin')?>/images/icons/color/edit.png" />
							</a>
							
							<a href="<?php echo base_url('admin/catalog/delete/'.$row->id)?>" title="Xóa" class="tipS verify_action" >
