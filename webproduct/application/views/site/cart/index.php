...
<div class="box-center" style="background-color:7FFFD4 "><!-- The box-center product-->
     <div class="tittle-box-center">
        <h2>Thông tin giỏ hàng (Có <?php echo $total_items?> sản phẩm) </h2>
      </div>
      <div class="box-content-center product" style="padding-left:205px"><!-- The box-content-center -->
            ...
            <table id="cart_ccontents">
               ...
               <tbody>
                    ...
                    <tr>
                     ...
                     <tr>
                       <td colspan="5">
                       <button type="submit" style="background-color:white;color:green">Cập nhật</button>
