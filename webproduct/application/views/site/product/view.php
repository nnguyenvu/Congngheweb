...
<div class="usual" id="usual1">
     <ul>
	       <li><a title="Chi tiết sản phẩm" rel='tab2' href="https://youtube.com/embed/FN7ALfpGxiI" target="_blank" class="tab selected"> Video chi tiết sản phẩm</a></li>
	       <li><iframe src="https://youtube.com/embed/FN7ALfpGxiI" allowfullscreen></iframe></li> 
	       <?php /*?>
...
<div class="usual-content">
     <div id="tab2"> 
    		<pre> <?php echo "Mô tả sản phẩm: ".$product->content?> </pre>
