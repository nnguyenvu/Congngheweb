...
Class Product extends MY_Controller
{
	...
	function index(){
		...
		$config['base_url']=base_url('product/index');//Link hien thi trang sp
		$config['per_page']=16;//So luong sp hien thi trong 1 trang
		$config['uri_segment']=3;//Phan doan hien thi ra so trang 
